    ...
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        ...
        <el-table v-loading="loading" :data="regionList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="所属县/区" align="center" width="100" prop="parentName" :show-overflow-tooltip="true"/>
      ...
      <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
        <el-form ref="form" :model="form" :rules="rules" label-width="80px">
          ...
          <el-form-item label="市级行政区" prop="parentCode" label-width="110px" v-show="isHide">
          ...
          <!--          <el-form-item label="城乡分类" prop="type" label-width="110px">
...
<!--          </el-form-item>-->
          <el-form-item label="更新人名称" v-show="isShow" prop="createUser" label-width="110px">
...
import {
  ...
  getChild,
  updateRegionOne,
  cityTree, listRegionTwo, getChildOne, listGsRegion, changeInvalidFlag
...
export default {
      ...
      if (val == null || val === "" || val === " ") {
        ...
        listGsRegion(this.queryParamOnes).then(response => {
          ...
          for (const rowElement of response.data) {
            if (rowElement.cityCode.toString().length > 6 || !rowElement.cityCode.toString().endsWith("00")) {
              this.defaultProps.isLeaf = "hasChild"
            }
  ...
  methods: {
    ...
    /** 删除按钮操作 */
    handleDelete(row) {
      this.$confirm('是否确认删除乡镇/街道编号为"' + row.regionId + '"的数据项?', "警告", {
